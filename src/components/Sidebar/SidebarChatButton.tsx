...
const SidebarChatButton = ({ chatItem, active, onClick, onDelete, onEdit }: Props) => {
    ...
    return (
        <div onClick={handleClickButton} className={`flex item-center rounded-md p-3 text-sm cursor-pointer hover:bg-gray-500/10 ${active ? 'bg-gray-500/20' : 'bg-transparent'} `}>
